...
with open(r'D:\中医问答\pythonProject1\A1A2_data_json\chap15_A1A2.json', encoding='utf-8') as f:
    data_json = json.load(f)
    # print(data_json)
    index =[362, 293 ,326  ,37 ,223 ,276 ,262 ,250 , 65, 415,56 ,307, 571 ,425,5, 201, 186 ,572 ,210 ,452]
print(index)
test_list = []
answer_list = []
for i in index:
