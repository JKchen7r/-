...
file_path = r'D:\中医问答\pythonProject1\A1A2_data_txt\chap8_A1A2.txt'
...
with open('../A1A2_data_json/chap8_A1A2.json', 'w', encoding='utf-8') as file:
    file.write('[')
    file.write('\n')
