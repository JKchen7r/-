...
file_path = r'D:\中医问答\pythonProject1\A3A4_data_txt\chap14_A3A4.txt'
...
with open('../A3A4_data_json/chap14_A3A4.json', 'w', encoding='utf-8') as file:
    file.write('[')
    file.write('\n')
